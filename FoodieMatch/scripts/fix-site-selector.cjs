...
const filePath = path.join(__dirname, '..', 'client', 'src', 'components', 'SiteSelector.tsx');

const newContent = `import { useSite, type Site } from '@/hooks/use-site';
...
console.log('SiteSelector.tsx 수정 완료');
