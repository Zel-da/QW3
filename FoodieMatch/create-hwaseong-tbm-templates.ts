...
const templates = {
  ...
  '제관라인_생산': {
    teams: ['BR로드생산', 'BR생산 열처리(주간)', 'BR생산 열처리(야간1조)', 'BR생산 열처리(야간2조)', 'BR생산 열처리(야간3조)', 'CR생산 팀장', 'CR생산 CR총괄'],
    items: [
      // TBM
      { category: 'TBM', subCategory: '도입', description: '아침 조회 - 아침 체조 스트레칭', displayOrder: 10 },
      { category: 'TBM', subCategory: '점검', description: '건강/복장/보호구 - 음주상태', displayOrder: 20 },
...
async function main() {
  ...
  console.log('화성 TBM 체크리스트 템플릿 등록 시작');
  console.log('='.repeat(60));
  console.log();
