...
export function registerTbmRoutes(app: Express) {
  ...
  // 월별 보고서 조회
  app.get("/api/tbm/monthly", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/tbm/attendance-overview", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/tbm/available-dates", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/tbm/check-existing", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // TBM 상세 조회
  app.get("/api/tbm/:reportId", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // TBM 수정
  app.put("/api/tbm/:reportId", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // TBM 삭제
  app.delete("/api/tbm/:reportId", requireAuth, async (req: Request, res: Response) => {
    try {
      const { reportId } = req.params;
