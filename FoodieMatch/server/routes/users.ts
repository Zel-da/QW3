...
export function registerUserRoutes(app: Express) {
  ...
  app.get("/api/users/pending", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/users/:userId", requireAuth, requireOwnership(), async (req: Request, res: Response) => {
    try {
  ...
  app.put("/api/users/:userId", requireAuth, requireOwnership(), async (req: Request, res: Response) => {
    try {
  ...
  app.put("/api/users/:userId/role", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
      const { role } = req.body;
  ...
  app.put("/api/users/:userId/site", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
      const { site } = req.body;
      const updatedUser = await prisma.user.update({
        where: { id: req.params.userId },
  ...
  app.delete("/api/users/:userId", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
      const user = await prisma.user.findUnique({ where: { id: req.params.userId } });
  ...
  app.put("/api/users/:userId/approve", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
  ...
  app.delete("/api/users/:userId/reject", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
      const { userId } = req.params;
  ...
  app.get("/api/admin/education-overview", requireAuth, requireRole('ADMIN', 'SAFETY_TEAM'), async (req: Request, res: Response) => {
    try {
      const users = await prisma.user.findMany({
        select: {
          id: true,
  ...
  app.get("/api/admin/dashboard-stats", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
      const now = new Date();
