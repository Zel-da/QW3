...
export function registerAuthRoutes(app: Express) {
  ...
  // 관리자용: 사용자 비밀번호 리셋
  app.put("/api/users/:userId/reset-password", requireAuth, requireRole('ADMIN'), async (req: Request, res: Response) => {
    try {
  ...
  // 아이디 찾기
  app.post("/api/auth/find-username", authLimiter, async (req: Request, res: Response) => {
    try {
