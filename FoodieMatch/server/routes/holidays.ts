...
export function registerHolidayRoutes(app: Express) {
  ...
  app.post("/api/holidays/range", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // 특정 날짜가 공휴일인지 체크 API
  app.get("/api/holidays/check", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.post("/api/holidays/fetch-korean", requireAuth, async (req: Request, res: Response) => {
    try {
      const { year } = req.body;
  ...
  // 공휴일 목록 조회 (연도/월 필터링)
  app.get("/api/holidays", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // 공휴일 추가
  app.post("/api/holidays", requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  // 공휴일 수정
  app.put("/api/holidays/:id", requireAuth, async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const { date, name, isRecurring, site } = req.body;
  ...
  // 공휴일 삭제
  app.delete("/api/holidays/:id", requireAuth, async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  // 공휴일 일괄 삭제
  app.delete("/api/holidays", requireAuth, async (req: Request, res: Response) => {
    try {
      const { ids } = req.body;
