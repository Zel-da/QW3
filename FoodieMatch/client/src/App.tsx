...
// 권한 그룹 정의
const ALL_ROLES = [Role.ADMIN, Role.APPROVER, Role.EXECUTIVE_LEADER, Role.TEAM_LEADER, Role.CONTRACTOR, Role.PENDING];
const ACTIVE_ROLES = [Role.ADMIN, Role.APPROVER, Role.EXECUTIVE_LEADER, Role.TEAM_LEADER, Role.CONTRACTOR]; // PENDING 제외
