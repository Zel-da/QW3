...
const menuItems: MenuItem[] = [
  ...
  { title: '사용자 도움말', description: '사용자 FAQ 및 안내', path: '/help', roles: ['ADMIN', 'TEAM_LEADER', 'EXECUTIVE_LEADER', 'EXECUTIVE'], icon: HelpCircle, bgColor: 'bg-sky-100', iconBg: 'bg-sky-500', iconColor: 'text-white' },
];
...
export default function AdminDashboardPage() {
  ...
  if (user?.role !== 'ADMIN' && user?.role !== 'TEAM_LEADER' && user?.role !== 'EXECUTIVE_LEADER' && user?.role !== 'EXECUTIVE') {
    return (
      <AdminPageLayout>
        <Card>
