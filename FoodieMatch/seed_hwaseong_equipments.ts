...
const equipmentData1: Record<string, Record<string, number>> = {
  '선삭': { '지게차': 1, '크레인': 14, '컨베이어': 0, 'CNC선반': 6, 'MCT': 9, 'Deep Hole': 1, '용접기': 0, '반전기': 0, '세척기': 0, '연삭기': 0, '도장장/건조로': 0, '밧데리충전기': 0, '템퍼링로': 0, '세척조/피트로/유조로': 0, '열처리/올케이스로': 0, '드릴(레디알)': 1, '시편절단기': 0, '탁상용연삭기': 1, '밴드쏘우': 1, '칩이송장치': 1, '굴착기': 0, '테스트크레인': 0 },
...
const equipmentData2: Record<string, Record<string, number>> = {
  ...
  'M/B': { '고속절단기': 0, '핸드그라인더': 0, '전동드릴/타카': 0, '작업대/발판': 0, '둥근톱': 1, '산소절단기': 1, '위험물/가스저장소': 1, '소화전/소화기': 1, '분배전반': 1, '걸이구': 1, '압력용기': 1, '공기압축기': 0, '가스분배기/쇼트기': 0 },
